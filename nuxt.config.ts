	...
	app: {
		head: {
			...
			script: [
				...
				{
					src: "https://uicdn.toast.com/editor-plugin-color-syntax/latest/toastui-editor-plugin-color-syntax.min.js",
					defer: true,
				},
				{
					src: "//dapi.kakao.com/v2/maps/sdk.js?appkey=NUXT_PUBLIC_KAKAO_MAP_API_KEY&libraries=services&autoload=false",
					defer: true,
				},
			],
		},
